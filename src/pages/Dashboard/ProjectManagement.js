    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 shadow-sm">
        <div className="relative flex items-center justify-between p-4">
          ...
          {/* More actions removed per request */}
        </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-white dark:bg-gray-800 shadow-xl flex flex-col h-full overflow-hidden">
