      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center mb-2">
            <span
              className={`px-3 py-1 rounded-full text-sm font-medium ${statusColor} mr-3`}
            >
              {statusText}
            </span>
        ...
        <Card padding={true} hover={true}>
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {currentProject.tasks?.completed || 0}/
                {currentProject.tasks?.total || 0}
              </p>
            </div>
          </div>
        ...
        <Card padding={true} hover={true}>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-500 mt-2">
            {currentProject.coordinator
              ? `Coordinator: ${currentProject.coordinator}`
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400 capitalize">
                            {task.status.replace("_", " ")} • Assigned to:{" "}
                            {task.assignee}
                          </p>
                        </div>
                      </div>
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        title: "Safety Review",
                        time: "Every Wednesday, 2:00 PM",
                        attendees: "Safety team",
                      },
                      {
                        title: "Client Update",
                        time: "Every Friday, 11:00 AM",
                        attendees: "Project Coordinator + Client",
                      },
                    ].map((meeting, index) => (
                      <div
                        key={index}
                        className="flex items-center p-3 hover:bg-white dark:hover:bg-gray-600 rounded"
                      >
