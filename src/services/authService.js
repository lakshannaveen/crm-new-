...
class AuthService {
  ...
  async register(userData) {
    ...
    const pendingUser = this.pendingRegistrations.find(u => u.phone === userData.phone);
    if (pendingUser) {
  ...
  async checkUserExists(phoneNumber) {
    ...
    const user = this.users.find(u => u.phone === phoneNumber);
    const pending = this.pendingRegistrations.find(u => u.phone === phoneNumber);
  ...
  async approveRegistration(userId) {
    ...
    const pendingIndex = this.pendingRegistrations.findIndex(u => u.id === userId);
